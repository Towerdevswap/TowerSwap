...
export const multicallAddresses = {
  ...
  56: '0xcA11bde05977b3631167028862bE2a173976CA111',
  97: '0xcA11bde05977b3631167028862bE2a173976CA11',
  5: '0xcA11bde05977b3631167028862bE2a173976CA11',
  4: '0xcA11bde05977b3631167028862bE2a173976CA11',
  256256: '0x3dc18345e131a673e11401696a35e7927673eeea',
  7001: '0xe9ED2bCAb953574bFe44aD1e24DD7f404046b985',
  7000: '0x88dBb8207f757C2D89eeb62Ea98418794D551e39',
  8453: '0x7D859E77E40dc2cF6E2d2a808f42711F6cd3054b',
  8082: '0x0f8aff1271eaeccac946360c2c9234391fc001ec',
  9000: '0x0F83A944bF73b85a90f012d5931Da10aF221FBF9',
}
...
export function createMulticall<TProvider extends Provider>(
  ...
  const multicall: MultiCall = async (abi: any[], calls: Call[], chainId = ChainId.CMP) => {
  ...
  const multicallv2: MultiCallV2 = async ({ abi, calls, chainId = ChainId.CMP, options, provider: _provider }) => {
  ...
  const multicallv3 = async ({ calls, chainId = ChainId.CMP, allowFailure, overrides }: MulticallV3Params) => {
    const multi = getMulticallContract(chainId, provider({ chainId }))
    if (!multi) throw new Error(`Multicall Provider missing for ${chainId}`)
