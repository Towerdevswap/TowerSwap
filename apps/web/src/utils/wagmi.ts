...
import { cmpMainnet, zetaMainnet, base, shardeumValidators, zeta, bsc, mainnet, quai } from '@pancakeswap/wagmi/chains'
...
const CHAINS = [zetaMainnet, base, shardeumValidators]
